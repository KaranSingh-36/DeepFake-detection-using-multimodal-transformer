...
print("=" * 80)
print("MULTIMODAL 10K CHECKPOINT - LAV-DF TEST EVALUATION")
print("=" * 80)
...
prediction_path = os.path.join(
    RESULTS_DIR,
    "multimodal_10000_test_predictions.csv"
)
...
metrics_path = os.path.join(
    RESULTS_DIR,
    "multimodal_10000_test_metrics.json"
)
...
plt.title(
    "Multimodal 10K - LAV-DF Test Confusion Matrix"
)
...
cm_path = os.path.join(
    RESULTS_DIR,
    "multimodal_10000_test_confusion_matrix.png"
)
